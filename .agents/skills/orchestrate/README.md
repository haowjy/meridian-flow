...
- `review.md` — default review, thoughtful senior dev (claude-opus-4-6)
- `review-thorough.md` — exhaustive auditor for important slices (gpt-5.3-codex, high effort)
- `review-quick.md` — fast sanity check (gpt-5.3-codex, low effort)
- `review-adversarial.md` — adversarial tester, writes scratch tests (claude-sonnet-4-6)
