 ...
 */
export function TwoPanelLayout({ panels, className, leftPanelView = 'chat' }: LayoutStrategyProps) {
  ...
  const effectiveRightCollapsed =
    rightPanelUserOverride === 'collapsed' || (rightPanelUserOverride === null && !rightPanelReady)
  ...
  return (
    <div className={cn('relative flex h-full w-full overflow-hidden', className)}>
      <ResizablePanelGroup direction="horizontal" autoSaveId="workspace:two-panel:v2">
        ...
        >
          ...
          <div className="relative h-full w-full overflow-hidden">
            ...
            {panels.projectSettings && (
              <Activity mode={leftPanelView === 'projectSettings' ? 'visible' : 'hidden'}>
        ...
        <ResizablePanel
          ...
          className={cn(
            ...
            !effectiveRightCollapsed && 'shadow-[-6px_0_16px_rgba(0,0,0,0.12)] z-10'
          )}
          collapsible
          collapsedSize={0}
          minSize={25}
