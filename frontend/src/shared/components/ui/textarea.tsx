    ...
    return (
      <textarea
        className={cn(
          ...
          "placeholder:text-muted-foreground bg-card border-editor-input-border w-full min-w-0 rounded-sm border px-3 py-2 text-base transition-all outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-[--opacity-disabled] md:text-sm font-sans",
