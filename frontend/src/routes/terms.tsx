  ...
  return (
    <div className="bg-background min-h-screen">
      <div className="container mx-auto max-w-2xl px-6 py-8">
        ...
        {/* Page title */}
        <h1 className="type-display mb-8">Terms of Service</h1>
        ...
        <div className="type-body text-foreground space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              and any activity that occurs under your account. You must provide
              accurate information when creating your account and keep it up to
              date.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              You retain full ownership of all content you create in Meridian,
              including documents, projects, and any other materials. We do not
              claim any ownership rights over your work.
            </p>
            <p>
              You grant Meridian a limited license to store, display, and
          ...
          <section className="space-y-3">
            ...
            <p>
              Meridian includes AI-powered writing assistance features. Please
              note:
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                AI-generated suggestions are provided as-is and may not always
                be accurate or appropriate
              </li>
              <li>
                You are responsible for reviewing and editing any AI-generated
                content before use
              </li>
              <li>
                Content you submit to AI features may be processed by
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              Meridian at any time for violations of these terms. You may also
