  ...
  return (
    <div className="bg-background min-h-screen">
      <div className="container mx-auto max-w-2xl px-6 py-8">
        ...
        {/* Page title */}
        <h1 className="type-display mb-8">Privacy Policy</h1>

        <div className="type-body text-foreground space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p>
              This privacy policy describes how Meridian ("we", "us") collects,
              uses, and shares personal information of users of
              meridian-flow.com and associated services (the "Services"). By
              using the Services, you consent to the practices described in this
              policy.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              <strong>User Content:</strong> Content you create and upload to
              Meridian, including documents, projects, prompts to AI features,
              and other files.
            </p>

            <p>
              <strong>Account Information:</strong> Information you provide when
              creating an account, such as your name, email address, and
              authentication provider identifiers.
            </p>

            <p>
              <strong>Automatically Collected Information:</strong> When you use
              our Services, we may automatically collect information such as
            ...
            <p>
              ...
              to provide functionality and personalize your experience. This
              includes session cookies (which expire when you close your
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                Conduct research and development using aggregated, anonymized
                data
              </li>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              third-party service providers who help us operate the Services,
              including cloud hosting, database, authentication, and AI
              providers. These may include services such as Supabase, Anthropic,
              and similar providers. When you use AI features, relevant content
              is sent to AI providers to process your requests.
            </p>

            <p>
              <strong>Professional Advisors:</strong> We may share information
              with lawyers, accountants, and other advisors in the course of
              their services to us.
            </p>

            <p>
              <strong>Corporate Transactions:</strong> If Meridian is involved
            ...
            <p>
              ...
              to comply with applicable laws, respond to legal process, or
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Email Communications:</strong> You may opt out of
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              the revised policy on this page and update the "Last updated"
