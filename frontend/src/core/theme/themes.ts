...
const modernLiterary: ThemePreset = {
  ...
  colors: {
    light: {
      ...
      shadow1: '0 1px 3px rgba(44, 36, 24, 0.12), 0 1px 2px rgba(44, 36, 24, 0.08)',
      shadow2: '0 4px 12px rgba(44, 36, 24, 0.15), 0 2px 4px rgba(44, 36, 24, 0.10)',
      shadow3: '0 10px 25px rgba(44, 36, 24, 0.18), 0 4px 10px rgba(44, 36, 24, 0.12)',
    ...
    dark: {
      ...
      shadow1: '0 1px 3px rgba(0, 0, 0, 0.35), inset 0 1px 0 rgba(255, 255, 255, 0.03)',
      shadow2: '0 4px 16px rgba(0, 0, 0, 0.45), 0 0 1px rgba(143, 185, 164, 0.08)',
      shadow3: '0 10px 30px rgba(0, 0, 0, 0.50), 0 0 20px rgba(143, 185, 164, 0.06)',
