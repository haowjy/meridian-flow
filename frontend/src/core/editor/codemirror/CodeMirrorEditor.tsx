...
>(function CodeMirrorEditor(
  ...
  useImperativeHandle(
    ...
    () => ({
      ...
      setContent(content: string, options?: SetContentOptions) {
        if (viewRef.current)
          dispatchSetContent(viewRef.current, content, options);
      },
      focus() {
      ...
      setLivePreviewEnabled(enabled: boolean) {
        if (viewRef.current)
          dispatchLivePreviewToggle(viewRef.current, enabled);
      },
    }),
    [],
  );
  ...
  useEffect(() => {
    ...
    const extensions = [
      ...
      // Default keymaps
      keymap.of([
        ...defaultKeymapWithoutBrowserNav,
        ...historyKeymap,
        ...closeBracketsKeymap,
      ]),
    ...
    if (onReady) {
      onReady({
        ...
        setContent: (content: string, options?: SetContentOptions) =>
          dispatchSetContent(view, content, options),
        focus: () => view.focus(),
        getView: () => view,
        ...
        setLivePreviewEnabled: (enabled: boolean) =>
          dispatchLivePreviewToggle(view, enabled),
      });
    }
