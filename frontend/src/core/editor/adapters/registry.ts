...
import type { EditorCapabilities, TypedContentAdapter, EditorContentMap } from './types'
 ...
 */
export function registerAdapter<T extends keyof AdapterMap>(adapter: AdapterMap[T]): void {
