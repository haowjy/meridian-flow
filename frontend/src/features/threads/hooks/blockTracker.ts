...
import { ToolArgsStreamTracker, type ToolArgsStreamSnapshot } from '@/features/threads/utils/toolArgsStreamTracker'
...
export class BlockTracker {
  ...
  appendToolJson(
    ...
    if (this.toolJsonTruncated.has(toolCallId)) {
      return { json: this.toolJsonBuffers.get(toolCallId) ?? '', truncated: true }
    }
