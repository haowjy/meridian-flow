    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="max-w-[200px] gap-1 truncate px-2 font-medium"
          disabled={isLoading}
        >
                  ...
                  <div className="flex shrink-0 items-center gap-0.5">
                    {onRename && (
                      <Button
                        ...
                        size="icon"
                        className={cn(
                          "h-4 w-5 rounded-sm p-0 transition-opacity",
                    ...
                    {onDelete && (
                      <Button
                        ...
                        size="icon"
                        className={cn(
                          "text-error hover:text-error h-4 w-5 rounded-sm p-0 transition-opacity",
                          "opacity-0 group-hover:opacity-100",
                        )}
                        onClick={(e) => {
                          e.stopPropagation();
