...
import { Bot, GitBranch, MessageSquare, MoreHorizontal, Pencil, Trash2 } from 'lucide-react'
  ...
  const itemContent = (
    ...
    >
      <button
        ...
        className={cn(
          'flex flex-1 min-w-0 items-center gap-2 pr-2.5 py-2 md:py-1',
      ...
      >
        <Icon data-icon className="size-5 md:size-4 flex-shrink-0" />
