...
import { TreeItemWithContextMenu, type TreeMenuItemConfig } from '@/shared/components/TreeItemWithContextMenu'
    ...
    <TreeItemInfoHoverCard type="skill" item={skill}>
      ...
      >
        ...
        >
          ...
          <Sparkles className="size-4 md:size-3.5 shrink-0 text-amber-500" />
