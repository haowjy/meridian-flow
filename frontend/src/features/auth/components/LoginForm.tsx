...
export function LoginForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-sm">
      ...
      <div className="bg-card border-border/50 rounded-xl border p-5 shadow-[var(--shadow-2)]">
        {/* Header */}
        ...
        {successMessage && (
          <div
            className="border-success/50 bg-success/10 mb-4 flex items-center gap-2 rounded-lg border px-3 py-2"
            role="status"
          >
