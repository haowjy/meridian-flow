...
import { handleTextMessageStart, handleTextMessageEnd } from '@/features/threads/hooks/sse/eventHandlers/textEventHandlers'
import { handleToolCallStart, handleToolCallArgs, handleToolCallEnd, handleToolCallResult } from '@/features/threads/hooks/sse/eventHandlers/toolEventHandlers'
import type { SSEDispatchContext, SSEStoreActions } from '@/features/threads/hooks/sse/types'
...
describe('SSE interleaving', () => {
  it('does not clear tool state when TEXT_MESSAGE_END arrives after TOOL_CALL_START', () => {
    ...
    handleTextMessageStart(
      { type: 'TEXT_MESSAGE_START', messageId: 'msg-1' } as TextMessageStartEvent,
      ctx,
      actions
    )
    ...
    handleToolCallResult(
      {
        ...
        messageId: 'msg-1',
        toolCallId: ' functions.doc_tree:0 ',
        content: JSON.stringify({ tool_use_id: ' functions.doc_tree:0 ', tool_name: 'doc_tree', is_error: false, result: {} }),
