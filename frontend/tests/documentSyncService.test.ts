...
describe('DocumentSyncService.save', () => {
  ...
  it('optimistically updates DB and applies server doc on success', async () => {
    ...
    await documentSyncService.save('d1', '<p>x</p>', { id: 'd1', projectId: 'p', folderId: null, name: 'n', path: 'n.md', extension: '.md', filename: 'n.md', fileType: 'markdown', content: '', updatedAt: new Date() }, { onServerSaved })
  ...
  it('queues retry on network/server error and calls onRetryScheduled', async () => {
    ...
    await documentSyncService.save('d2', '<p>y</p>', { id: 'd2', projectId: 'p', folderId: null, name: 'n', path: 'n.md', extension: '.md', filename: 'n.md', fileType: 'markdown', content: '', updatedAt: new Date() }, { onRetryScheduled })
  ...
  it('bubbles client errors (validation) to caller', async () => {
    ...
    await expect(
      documentSyncService.save('d3', '<p>z</p>', { id: 'd3', projectId: 'p', folderId: null, name: 'n', path: 'n.md', extension: '.md', filename: 'n.md', fileType: 'markdown', content: '', updatedAt: new Date() })
