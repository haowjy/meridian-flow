...
CREATE INDEX "thread_execution_reports_pending" ON "thread_execution_reports" USING btree ("created_at") WHERE "thread_execution_reports"."publication" = 'pending';--> statement-breakpoint
