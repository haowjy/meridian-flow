...
ALTER TABLE "document_yjs_updates" ADD COLUMN "birth_class" text DEFAULT 'agent' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "document_yjs_updates" ADD CONSTRAINT "document_yjs_updates_birth_class_valid" CHECK ("document_yjs_updates"."birth_class" IN ('writer_protected', 'agent'));