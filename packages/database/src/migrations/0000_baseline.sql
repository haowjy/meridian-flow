...
ALTER TABLE "project_user_working_sets" ADD CONSTRAINT "project_user_working_sets_last_thread_id_threads_id_fk" FOREIGN KEY ("last_thread_id") REFERENCES "public"."threads"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
