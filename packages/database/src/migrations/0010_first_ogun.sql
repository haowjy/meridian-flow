...
--> statement-breakpoint
ALTER TABLE "document_restore_points" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
DROP TABLE "document_restore_points" CASCADE;--> statement-breakpoint
...
CREATE INDEX "document_yjs_reversals_document_thread" ON "document_yjs_reversals" USING btree ("document_id","thread_id","scope_id");--> statement-breakpoint
ALTER TABLE "document_yjs_updates" DROP COLUMN "actor_agent_run_id";--> statement-breakpoint
