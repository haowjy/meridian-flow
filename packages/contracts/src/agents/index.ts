/**
 * Agent catalog contract — the workbench-scoped list of selectable agents.
 *
...
/** One selectable agent in a workbench's catalog. */
export interface WorkbenchAgentSummary {
...
/** Response shape for `GET /api/workbenches/:workbenchId/agents`. */
export interface WorkbenchAgentsResponse {
  agents: WorkbenchAgentSummary[];
}
