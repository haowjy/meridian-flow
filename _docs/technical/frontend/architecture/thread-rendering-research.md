...
**See also:**
- `../thread-rendering.md` - Decision summary
- `../thread-rendering-guide.md` - Implementation guide
...
- **Current chat UI:** `frontend/src/features/threads/components/ActiveThreadView.tsx`
...
**Next steps:** See `../thread-rendering-guide.md` for implementation
