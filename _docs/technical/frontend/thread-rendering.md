...
# Thread Rendering: Streamdown Decision

**Purpose:** Document why Streamdown was chosen for thread message rendering over other options.

**See also:**
- `thread-rendering-guide.md` - Implementation guide and best practices
- `architecture/thread-rendering-research.md` - Full research and comparisons

## Decision

**Use Streamdown for thread message rendering.**
...
- Exponential performance degradation with thread history
...
See `thread-rendering-guide.md` for:
...
- **Current frontend implementation:** `frontend/src/features/threads/components/ActiveThreadView.tsx`
