...
CREATE INDEX IF NOT EXISTS idx_user_project_favorites_user
...
CREATE INDEX IF NOT EXISTS idx_projects_user_last_activity
ON ${TABLE_PREFIX}projects (user_id, last_activity_at DESC)
WHERE deleted_at IS NULL;

-- +goose Down
DROP INDEX IF EXISTS idx_projects_user_last_activity;
