...
type ArbiterStrategy interface {
	Name() string
	Evaluate(ctx context.Context, input collabSvc.ArbiterInput) collabSvc.ArbiterDecision
}
...
func NewStrategyChainArbiter(strategies []ArbiterStrategy, logger *slog.Logger) *StrategyChainArbiter {
