...
type ThreadService interface {
	...
	CreateThread(ctx context.Context, req *CreateThreadRequest) (*llm.Thread, error)
	...
	ListThreads(ctx context.Context, projectID, userID string) ([]llm.Thread, error)

	// UpdateThread updates a thread's title
	// Validates user has access
	UpdateThread(ctx context.Context, threadID, userID string, req *UpdateThreadRequest) (*llm.Thread, error)
