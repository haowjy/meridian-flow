...
- Show the project name instead of the workspace compass, with an explicit return to the library. Rename from the desktop rail or phone drawer; update the library at once and reject blank titles.
