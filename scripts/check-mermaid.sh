...
# Usage:
#   ./scripts/check-mermaid.sh                    # all _docs/ and scratch/ .md files
#   ./scripts/check-mermaid.sh path/to/file.md    # specific file(s)
#   ./scripts/check-mermaid.sh _docs/features/    # specific directory
#
