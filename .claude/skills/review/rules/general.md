...
12. **Check shared utilities before creating new ones**: Backend: `internal/util/`, Frontend: `core/lib/`.

## Feature Documentation

13. **Feature changes require doc updates**: When adding or significantly updating a feature, update `_docs/features/` and `_docs/features/README.md` status if needed.
