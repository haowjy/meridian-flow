...
Read `_docs/future/refactoring-backlog.md` to understand current items and their format.
...
2. Look for refactoring opportunities using the review rules in `.claude/skills/review/rules/general.md` — key signals:
...
After any changes, update `_docs/future/refactoring-backlog.md` using the existing table format:
