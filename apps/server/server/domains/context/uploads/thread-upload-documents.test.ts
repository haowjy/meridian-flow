...
describe("thread upload document read path", () => {
  it("getUpload trusts persisted fileType when filetype is null (Drizzle binary shape)", async () => {
    ...
    await store.createUploadDocument({
      id: documentId,
      workbenchId: "00000000-0000-4000-8000-000000000603",
      threadId,
      filename: "gel.png",
      name: "gel",
      extension: "png",
      ...
      sizeBytes: 3,
      markdownProjection: "",
      storageUrl: "object://meridian/uploads/workbench/thread/document/png",
    });
  ...
  it("listRecent trusts persisted fileType when filetype is null (Drizzle binary shape)", async () => {
    ...
    await store.createUploadDocument({
      id: documentId,
      workbenchId: "00000000-0000-4000-8000-000000000613",
      threadId,
      filename: "scan.pdf",
      name: "scan",
      extension: "pdf",
      ...
      sizeBytes: 9,
      markdownProjection: "",
      storageUrl: "object://meridian/uploads/workbench/thread/document/pdf",
    });
