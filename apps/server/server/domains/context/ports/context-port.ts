 ...
 *
 * - `fs1`     — workbench files (uploaded data, generated outputs). Bare paths default here.
 * - `kb`      — workbench knowledge base (agent-maintained).
 * - `work`    — per-work scratchpad / working memory.
 * - `user`    — user-scoped file tree, cross-workbench.
 */
