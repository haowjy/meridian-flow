...
export interface PackageWriteTransaction {
  ...
  listSelectableAgents(projectId: string | null): Promise<AgentDefinitionRecord[]>;
  /** Full agent inventory for a scope — includes disabled and subagents. */
  listProjectAgentDefinitions(projectId: string | null): Promise<AgentDefinitionRecord[]>;
  listPackageInstalls(projectId: string): Promise<PackageInstallRecord[]>;
  ...
  findSkillBySlug(projectId: string | null, slug: string): Promise<SkillRecord | undefined>;
  findSkillDefinition(projectId: string | null, slug: string): Promise<SkillRecord | undefined>;
  /** Slug lookup including disabled/retired rows — install collision checks only. */
  ...
  listProjectSkills(projectId: string | null): Promise<SkillRecord[]>;
  /** Full skill inventory for a scope — includes disabled definitions. */
  listProjectSkillDefinitions(projectId: string | null): Promise<SkillRecord[]>;
