...
Evaluate motivation coherence, arc progression, and relationship dynamics.
...
- Is the motivation consistent with how they've behaved previously?
...
Character arcs need to be visible in the character's behavior, not just in the narration about them.

**Tracking the arc:** Where is this character in their arc at this point? Has the draft shown the incremental changes that move them from their starting state toward their ending state?

**Earned change:** Major character shifts need precipitating events. A character who's been stubborn for ten chapters doesn't reverse in a paragraph because the plot needs them to grow. What happened that was powerful enough to change this person?

**Regression is valid.** Characters don't progress linearly. They backslide, resist, have partial breakthroughs that don't stick. Arc progression that's too smooth reads as inauthentic.

**Flat arcs are valid too.** Not every character needs to change. Some characters are catalysts who change others while staying the same. The question is whether the arc type (change or flat) is intentional.
...
Can you tell which character is speaking without dialogue tags? Each character should have their own vocabulary, sentence structure, preoccupations, and verbal habits.

Common failure: all characters become equally articulate, insightful, and emotionally fluent. Real people aren't. Some characters are inarticulate. Some deflect. Some lecture. Some barely speak. The variation IS the characterization.

In first person or close third, the narration itself should sound like the POV character. A teenager doesn't narrate like a professor, even in their own head.
