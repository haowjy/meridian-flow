  ...
  return [
    ...
    },
    {
      ...
      definition: {
        ...
        name: "list",
        description:
          "List files and directories under a path or URI. Use this to inspect workbench files, knowledge base folders, work memory, or user files before reading specific files.",
        inputSchema: {
          type: "object",
          properties: {
            path: {
    ...
    },
    {
      ...
      definition: {
        ...
        name: "search",
        description:
          "Search workbench context files for a query. Use this to find relevant knowledge-base, work-memory, or user files before reading them.",
        inputSchema: {
          type: "object",
          properties: {
            query: {
