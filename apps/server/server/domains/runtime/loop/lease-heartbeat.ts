...
export function createHeartbeatRunAuthority(
  ...
  return {
    ...
    setAdoptedMessageIds: (lease, messageIds) => authority.setAdoptedMessageIds(lease, messageIds),
    readAdoptedMessageIds: (lease) => authority.readAdoptedMessageIds(lease),
