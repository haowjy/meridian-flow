...
export const RUNTIME_URI_SYSTEM_INSTRUCTION =
  "Context file URI rules: bare file paths resolve as fs1:// project workspace files. Use explicit kb:// URIs for workbench knowledge-base files, including when using read, write, edit, list, or search.";
