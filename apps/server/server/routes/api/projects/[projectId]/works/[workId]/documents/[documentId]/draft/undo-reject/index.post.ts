/** POST /api/projects/:projectId/works/:workId/documents/:documentId/draft/undo-reject: reactivate a discarded AI draft. */
...
export default defineEventHandler(async (event) => {
  ...
  return handleWorkDraftUndoRejectRequest(selectDraftRouteServices(app), {
