/**
 * Workbench package install route core: owner-gated preview and apply for Mars
...
export interface WorkbenchPackageInstallRouteDeps {
  workbenchRepo: WorkbenchRepository;
  packageRepository: PackageRepository;
  marsPackageFetcher: MarsPackageFetcher;
}

export interface WorkbenchPackageInstallRouteInput {
  workbenchId: string;
  userId: string;
}
...
export async function handlePreviewPackageInstallRequest(
  deps: WorkbenchPackageInstallRouteDeps,
  input: WorkbenchPackageInstallRouteInput & PackageInstallPreviewRequest,
...
export async function handleApplyPackageInstallRequest(
  deps: WorkbenchPackageInstallRouteDeps,
  input: WorkbenchPackageInstallRouteInput & PackageInstallApplyRequest,
