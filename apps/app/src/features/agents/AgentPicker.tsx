 ...
 * workbench catalog. Quiet loading/empty/error states; no default-agent or
...
import type { WorkbenchAgentsStatus } from "@/client/query/useWorkbenchAgents";
