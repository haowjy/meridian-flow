...
import { useCreateBoundProjectThread } from "./use-create-bound-thread";
...
export function useTestAgent({ projectId, onSelectDockThread }: UseTestAgentArgs) {
  const createBound = useCreateBoundProjectThread(projectId);
