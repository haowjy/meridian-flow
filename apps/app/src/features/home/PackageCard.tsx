...
export function PackageCard({ pkg, onSelect }: PackageCardProps) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      aria-label={name}
      className="surface-card focus-ring flex min-w-[200px] max-w-[280px] cursor-pointer flex-col gap-2 rounded-lg px-4 py-3 text-left transition-colors hover:bg-muted"
    >
