/** Content predicate that makes a reserved local document eligible for remote creation. */
import * as Y from "yjs";

export function resourceDocumentIsEmpty(fragment: Y.XmlFragment): boolean {
