// @ts-nocheck
/**
 * MobileWorkbench — phone-class workbench shell with one active view at a time.
 *
 * This is a sibling of the desktop WorkbenchShell, not a conditional branch
...
import { useWorkbenchThreadGroups } from "../data/dashboard-data";
import type { ProjectViewProps } from "../WorkbenchView";
...
export function MobileWorkbench(props: ProjectViewProps) {
...
function renderActiveView(
  ...
  if (props.resultsOpen) {
    return <MobileResultsView workbenchId={props.workbenchId} />;
  }

  switch (props.activeScreen) {
    case "home":
      return (
        <MobileHomeScreen workbenchId={props.workbenchId} onSelectThread={props.onSelectThread} />
      );
    case "chat":
      return (
        <MobileChatHost
