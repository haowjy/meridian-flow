...
const MOBILE_DOCUMENT_OWNER = "mobile-workbench-document-host";
...
export function MobileDocumentHost({
  ...
  const { tree, isError, isFetching } = useWorkbenchContextTree(
    workbenchId,
  ...
  if (!activeTab.editable) {
    return <ContextViewerBareHost workbenchId={workbenchId} tab={activeTab} />;
  }
