// @ts-nocheck
/**
 * ChatSurface — the single, persistent chat instance for the desktop workbench.
 *
 * Mounted ONCE above the destination switch (see `DesktopWorkbench`) and never
 ...
 * draft all survive a destination change. The workbench SlotGrid moves this
