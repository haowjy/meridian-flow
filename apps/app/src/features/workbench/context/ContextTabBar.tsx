 ...
 * elsewhere in the workbench (subtle primary tint, full-foreground text).
 *
 * Layout is three zones — pinned `leading` on the left, scrollable tabs in
 * the middle, pinned `trailing` on the right — so the workbench's
 ...
 * workbench `.context/CONTEXT.md` seam invariant). Per-tab chips carry
...
export type ContextTabBarProps = {
  ...
  /**
   * Pinned control docked at the strip's far-left edge (e.g. the workbench
