 ...
 * cohesive component — the tab strip (workbench sidebar/dock toggles + open
 ...
 *    context-files-panel`), rehydrated behind the workbench hydration gate.
...
export type ContextViewerProps = {
  ...
  /**
   * Workbench left-sidebar expand toggle (pinned at the tab strip's leading
  ...
  /**
   * Workbench right-dock expand toggle (pinned at the tab strip's trailing
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          ...
          {activeTab && !activeIsTracked ? (
            <div className="flex min-h-0 flex-1 flex-col">
              <ContextViewerHost workbenchId={workbenchId} tab={activeTab} />
            </div>
          ) : null}
          {!activeTab ? (
            <Placeholder>
