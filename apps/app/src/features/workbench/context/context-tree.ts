// @ts-nocheck
/**
 * context-tree — type aliases and lookup helpers for a workbench's context
 * document tree.
 *
...
import type {
  ...
  WorkbenchContextTreeNode,
} from "@meridian/contracts/protocol";

export type ContextDir = WorkbenchContextTreeDirectory;
export type ContextFile = WorkbenchContextTreeFile;
export type ContextNode = WorkbenchContextTreeNode;
...
/**
 * Look up a directory by its absolute path (e.g. `/workbench/learnings`). The
