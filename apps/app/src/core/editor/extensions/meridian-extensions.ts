// @ts-nocheck
/**
 * meridian-extensions — the workbench's customized TipTap node/mark extensions.
 *
...
export const MeridianFigure = Node.create<{ workbenchId?: string; documentId?: string }>({
  name: "figure",
  group: "block",
  atom: true,
  defining: true,
