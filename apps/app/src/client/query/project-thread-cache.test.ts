/**
 * project-thread-cache tests — guards cache reconciliation for denormalized
...
import { readProjectThreadList, upsertThreadInProject } from "./project-thread-cache";
...
describe("upsertThreadInProject", () => {
  it("clears stale lifecycle fields when an idle snapshot is applied", () => {
    ...
    client.setQueryData(projectQueryKeys.threads(PROJECT_ID), [
