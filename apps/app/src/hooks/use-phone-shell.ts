// @ts-nocheck
/**
 * usePhoneShell — device-capability predicate for selecting the phone workbench shell.
 *
 ...
 * while iPad mini landscape (744px tall) stays on the desktop workbench. Hover
